...
public class MainProgram {
    ...
    public static void main(String[] args) {
        ...
        while (actualNumber != -1) {
            actualNumber = Integer.valueOf(scanner.nextLine());
            if (actualNumber != -1) {
                statistics.addNumber(actualNumber);
                if (actualNumber % 2 != 0) {
                    oddStatistics.addNumber(actualNumber);
                } else {
                    evenStatistics.addNumber(actualNumber);
                }
            }
        }
